...
TEST(Div, div1) {
    ...
    LongNumber b = LongNumber("1");
    auto ans = (a / b);
    std::cout << "Test div1. Expected:" << a.to_string() << " Received: " << ans.to_string() << std::endl;
    EXPECT_EQ(ans, a);
}
...
TEST(Div, div2) {
    ...
    std::cout << "Test div1. Expected:" << cor_ans.to_string() << " Received: " << ans.to_string() << std::endl;
    EXPECT_EQ(ans, cor_ans);
}
...
TEST(Div, div3) {
    ...
    std::cout << "Test div2. Expected:" << cor_ans.to_string() << " Received: " << ans.to_string() << std::endl;
    EXPECT_EQ(ans, cor_ans);
}
